...
public class FirebaseConfig {
    ...
    /**
     * FirebaseMessaging bean for sending push notifications (Cloud Messaging).
     * Returns null in dev-fallback mode (no real service account credentials) —
     * NotificationService must null-check this before sending.
     */
    @Bean
    public FirebaseMessaging firebaseMessaging(FirebaseApp firebaseApp) {
        try {
            ...
            log.warn("FirebaseMessaging instance unavailable: {}", e.getMessage());
        }
        return null;
    }
}
