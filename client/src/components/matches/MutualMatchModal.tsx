  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Header Title: Heart & It's a match! */}
        ...
        >
          ...
          {/* Left Hot-Air Balloon (Match Avatar) */}
          <div
            style={{
              position: 'absolute',
              left: '42px',
          ...
          {/* Right Hot-Air Balloon (User Avatar) */}
          <div
            style={{
              position: 'absolute',
              right: '42px',
        ...
        {/* Action Buttons: "Send Message" and "Keep Swiping" */}
        <div
          style={{
            width: '100%',
            display: 'flex',
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              border: 'none',
              cursor: 'pointer',
              boxShadow: '0 10px 24px rgba(190, 18, 60, 0.4)',
              transition: 'all 0.2s cubic-bezier(0.16, 1, 0.3, 1)',
              letterSpacing: '0.01em'
            }}
            onMouseEnter={(e) => {
              e.currentTarget.style.transform = 'translateY(-2px) scale(1.01)';
              e.currentTarget.style.boxShadow = '0 14px 30px rgba(190, 18, 60, 0.5)';
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.transform = 'translateY(0) scale(1)';
              e.currentTarget.style.boxShadow = '0 10px 24px rgba(190, 18, 60, 0.4)';
            }}
          >
            Send Message
          </button>

          {/* Secondary Link: Keep Swiping */}
          <button
