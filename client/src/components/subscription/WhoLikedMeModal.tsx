...
export const WhoLikedMeModal: React.FC = () => {
  ...
  // Unlocked for PRO/VIP members AND for anyone with money in the wallet.
  const isPremium = !!currentUser.isPremium || canSeeLikerNames;
        ...
        {!isPremium && (
          ...
          >
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: '0.78rem', color: 'var(--text-secondary)' }}>
                    Upgrade to PRO or VIP for 28-day unblurred admirer access.
                  </div>
                </div>
              </div>
              ...
              >
                <Sparkles size={14} /> Upgrade to PRO / VIP
              </Button>
            </div>
          </div>
        )}
          ...
          {whoLikedMeProfiles.map((item) => {
            ...
            return (
              <div
                ...
                onClick={() => {
                  if (isPremium) {
                    // close this pop-up first, otherwise the profile opens hidden behind it
                    closeWhoLikedMeModal();
