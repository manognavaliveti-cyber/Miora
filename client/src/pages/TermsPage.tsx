...
export const TermsPage: React.FC = () => {
  ...
  const sections = [
    ...
    },
    {
      id: 'section-10',
      num: '10',
      title: 'MIORA ₹ WALLET CREDIT AND DIGITAL FEATURES',
      icon: <Wallet size={18} color="var(--berry-primary)" />,
      content: (
        <>
          <p style={{ marginBottom: '12px', lineHeight: 1.7 }}>
            MIORA provides in-app ₹ Wallet credit for eligible features, chat, and call packages within the Platform.
          </p>
          <p style={{ marginBottom: '10px', fontWeight: 700, color: 'var(--text-primary)' }}>
            MIORA ₹ Wallet Credit:
          </p>
          <ul style={{ paddingLeft: '24px', marginBottom: '14px', lineHeight: 1.7, display: 'flex', flexDirection: 'column', gap: '6px' }}>
            <li>Is in-app digital credit for features within MIORA.</li>
            <li>Is not legal tender.</li>
            <li>Is not a bank deposit.</li>
            <li>Is non-withdrawable and has no cash value outside MIORA.</li>
